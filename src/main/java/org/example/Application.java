...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        try (TelegramBotsLongPollingApplication botsApplication = new TelegramBotsLongPollingApplication()) {
            ...
            atmosphereService = new AtmosphereService(atmosphere);

            botsApplication.registerBot(System.getenv("BOT_TOKEN"), new WeatherBot(emodjiService, weatherTranslateService, atmosphereService));
